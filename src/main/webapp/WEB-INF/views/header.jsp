		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item"><a href="${pageContext.request.contextPath}/login" class="nav-link" style="font-family: Poppins-Regular;">Login</a></li>
					<%
						} else {
					%>
					<li class="nav-item"><a href="${pageContext.request.contextPath}/bar" class="nav-link" style="font-family: Poppins-Regular;">Monitor</a></li>
					<li class="nav-item"><a href="${pageContext.request.contextPath}/report" class="nav-link" style="font-family: Poppins-Regular;">Logs</a></li>
					<li class="nav-item"><a href="${pageContext.request.contextPath}/profile" class="nav-link" style="font-family: Poppins-Regular;">Profile</a></li>
					<li class="nav-item"><a href="${pageContext.request.contextPath}/logout" class="nav-link" style="font-family: Poppins-Regular;">Logout</a></li>
					<%
						}
					%>
				</ul>
