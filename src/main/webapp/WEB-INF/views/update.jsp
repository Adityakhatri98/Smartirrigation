			...
			<div class="container-login100">
				<div class="wrap-login100">
					<div class="login100-form validate-form">
						...
						<div class="wrap-input100 validate-input">
							<s:input class="input100  has-val" type="text" path="phone" />
						...
						<div class="wrap-input100 validate-input">
							<s:input class="input100  has-val" type="text" path="address" />
						...
						<div class="wrap-input100 validate-input">
							<s:input class="input100 has-val" type="text" path="pincode" />
						...
						<div class="wrap-input100 validate-input"
							...
							<s:input class="input100 has-val" type="text" path="email"
								readonly="true" cssStyle="color:grey; font-weight:bold;" />
						...
						<div class="wrap-input100 validate-input"
							...
							<s:input class="input100 has-val" type="password" path="pwd" />
