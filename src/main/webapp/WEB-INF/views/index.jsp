		...
		<div class="container">
			<div
				...
				<div class="col-md-8 ftco-animate text-center">
					<h1 class="mb-4">The most valuable thing is Our Health</h1>
					<p>Irrigation that saves you Money Professional Irrigation
						Design that takes into account all facets of each project to
						maximize efficiency, minimize water consumption and eliminate
						non-target watering. From water use audits to system maintenance,
						winterization (line blow-outs) and rainwater harvesting Smart
						Watering Systems will ensure your automated sprinkler system
						(irrigation) is working perfectly.</p>
				</div>
			</div>
		...
		<div class="container">
			<div class="row justify-content-center mb-5 pb-3">
				<div
					...
					<h2 class="mb-4">Some facts about agricultural of india</h2>
